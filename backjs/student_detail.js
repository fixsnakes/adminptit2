var arrays = [
    {name:"Bài Thi Số 1", type_test:"Luyện Tập", type_class:"test train-type", date:"Tự Do",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 2", type_test:"Cuối Kỳ", type_class:"test train-type", date:"06/07/2023",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 3", type_test:"Giữa Kỳ", type_class:"test train-type", date:"06/07/2023",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 1", type_test:"Luyện Tập", type_class:"test train-type", date:"Tự Do",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 2", type_test:"Cuối Kỳ", type_class:"test train-type", date:"06/07/2023",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 3", type_test:"Giữa Kỳ", type_class:"test train-type", date:"06/07/2023",date_create:"05/09/2026", cnt_test:"100",point:"9"},
    {name:"Bài Thi Số 1", type_test:"Luyện Tập", type_class:"test train-type", date:"Tự Do",date_create:"05/09/2026", cnt_test:"100",point:"9"},
...
var student_data = [
    {avatar:"assets/haitu.jpg",msv:"B21DCCN475",name:"Lê Quang Hải Tú",date:"04/07/2003",status:"Đang Hoạt Động",ip:"1.59.55.22"},
    {avatar:"assets/user.jpg",msv:"B21DCCN475",name:"Đào Tùng Lâm",date:"04/07/2003",status:"10 Phút Trước",ip:"1.59.55.22"},
    {avatar:"assets/rose.jpg",msv:"B21DCCN475",name:"Rose",date:"04/07/2003",status:"Đang Hoạt Động",ip:"1.59.55.22"},
    {avatar:"assets/jisoo.jpg",msv:"B21DCCN475",name:"Jisoo",date:"04/07/2003",status:"10 Phút Trước",ip:"1.59.55.22"},
    {avatar:"assets/haitu.jpg",msv:"B21DCCN475",name:"Lê Quang Hải Tú",date:"04/07/2003",status:"Đang Hoạt Động",ip:"1.59.55.22"},
    {avatar:"assets/user.jpg",msv:"B21DCCN475",name:"Đào Tùng Lâm",date:"04/07/2003",status:"10 Phút Trước",ip:"1.59.55.22"},
    {avatar:"assets/rose.jpg",msv:"B21DCCN475",name:"Rose",date:"04/07/2003",status:"Đang Hoạt Động",ip:"1.59.55.22"},
    {avatar:"assets/jisoo.jpg",msv:"B21DCCN475",name:"Jisoo",date:"04/07/2003",status:"10 Phút Trước",ip:"1.59.55.22"},
...
for(var i = 0; i < student_data.length; i++){
    ...
    <tr id = "row-${i+1}">
                                ...
                                <td><p>${arrays[i].point}</p></td>
                                <td><p>${arrays[i].cnt_test}</p></td>
                                <td><p>Hoàn Thành</p></td>
                                <td><a href="result.html"><i class="fa-sharp fa-solid fa-eye"></i></a></td>
    </tr>
    `
    ...
    <div class="quiz-detail" id="quiz-detail-${totalQuizDetails+1}">
                            ...
                            <div class="dapan">
                                <div class="answer-content">
                                    ...
                                    <input type="text" id="A-${totalQuizDetails+1}">
                                </div>
                                <div class="answer-content">
                                    <p id="answer-content-1">B.</p>
                                    <input type="text" id="B-${totalQuizDetails+1}">
                                </div>
                                <div class="answer-content">
                                    <p id="answer-content-1">C.</p>
                                    <input type="text" id="C-${totalQuizDetails+1}">
                                </div>
                                <div class="answer-content">
                                    <p id="answer-content-1">D.</p>
                                    <input type="text" id="D-${totalQuizDetails+1}">
                                </div>
